    ...
    <div className='background'>
      ...
      <div className="team">
        <div className="aaron">
          ...
          <img className="profile" src={require("../../img/Aaron.jpg")} alt="profile-picture" />
